...
class Scraper:
    ...
    def get_client(self, api_id, api_hash):
        try:
            ...
            logger.error("[SCRAPER]:  Error in getting client: ", str(e))
    ...
    async def get_group_entity(self, group_username):
        try:
            ...
            logger.error("[SCRAPER]: Error in getting group entity: ", str(e))
    ...
    async def get_group_messages(self, entity):
        try:
            ...
            logger.error("[SCRAPER]: Error in getting group messages: ", str(e))
    ...
    async def get_messages(self, phone_number, group_username):
        try:
            ...
            logger.error("[SCRAPER]: Error in getting messages: ", str(e))
